...
const TilesService = () => {
  ...
  return (
    ...
    <Card.Text style={{margin:'auto',backgroundColor:'#0B8A55',color:'white',textAlign:'center',padding:'20px'}}>
      <span>আপনার ঘরের টাইলস লাগানোর জন্য কর্মী পেতে চান, তাহলে আমাদের নিচের ফর্মটি পূরণ করে সাবমিট করুন</span>
      
    </Card.Text>
  <FormContainer>
    <h1 style={{color:'#0B8A55',textAlign:'center'}}>টাইলস সার্ভিস</h1>
