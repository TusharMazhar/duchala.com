  ...
  return (
    <Card.Body>
      <Card.Text style={{margin:'auto',backgroundColor:'#0B8A55',color:'white',textAlign:'center',padding:'20px'}}>
        <span>আপনি যদি যেকোনো প্রয়োজনে কার(Car) ভাড়া করতে চান,নিচের ফর্মটি পূরণ করে সাবমিট করুন।</span>
        
      </Card.Text>
    <FormContainer>
      <h1 style={{color:'#0B8A55',textAlign:'center'}}>কার সার্ভিস</h1>
      <Form onSubmit={submitHandler}>
        ...
        <Form.Label style={{display:'block'}}>গাড়ির বর্ণনা</Form.Label>
          <textarea
            ...
            type='description'
            placeholder='আপনার কতটি কার(Car) দরকার,কি ধরনের কার দরকার এবং কোন তারিখে দরকার বিস্তারিত লিখুন'
            value={description}
