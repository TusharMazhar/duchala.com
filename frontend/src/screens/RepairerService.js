...
const RepairerService = () => {
    let history = useHistory()
    const [name,setName] = useState('')
    const [phone,setPhone] = useState('')
    const category = 'Repairer'
  ...
  return (
    ...
    <Card.Text style={{margin:'auto',backgroundColor:'#0B8A55',color:'white',textAlign:'center',padding:'20px'}}>
      <span>আপনার ফ্রীজ/টিভি/অন্যান্য জিনিস যদি ঘরে বসে সার্ভিস করাতে চান, তাহলে আমাদের নিচের ফর্মটি পূরণ করে সাবমিট করুন</span>
      
    </Card.Text>
  <FormContainer>
    <h1 style={{color:'#0B8A55',textAlign:'center'}}>রিপেয়ার সার্ভিস</h1>
    <Form onSubmit={submitHandler}>
      ...
      <Form.Group controlId='description'>
        ...
        <textarea
          ...
          type='description'
          placeholder='আপনি কি কাজ করাতে বিস্তারিত লিখুন'
          value={description}
...
export default RepairerService 
