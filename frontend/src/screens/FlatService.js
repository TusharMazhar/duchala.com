  ...
  return (
    <Card.Body>
      <Card.Text style={{margin:'auto',backgroundColor:'#0B8A55',color:'white',textAlign:'center',padding:'20px'}}>
        <span>আপনি যদি বাসা/দোকান ভাড়া নিতে চান, তাহলে আমাদের নিচের ফর্মটি পূরণ করে সাবমিট করুন</span>
        
      </Card.Text>
    <FormContainer>
      <h1 style={{color:'#0B8A55',textAlign:'center'}}>বাসা/দোকান ভাড়া সার্ভিস</h1>
      <Form onSubmit={submitHandler}>
        ...
        <Form.Group controlId='description'>
          <Form.Label style={{display:'block'}}>বাসা/দোকানের বর্ণনা</Form.Label>
          <textarea
            style={{width:'300px',height:'100px',paddingLeft:'20px',paddingTop:'10px'}}
            type='description'
            placeholder='আপনি কি ধরনের বাসা/দোকান ভাড়া নিতে চান  বিস্তারিত লিখুন'
            value={description}
