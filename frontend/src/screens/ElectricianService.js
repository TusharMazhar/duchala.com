  ...
  return (
    <Card.Body>
      <Card.Text style={{margin:'auto',backgroundColor:'#0B8A55',color:'white',textAlign:'center',padding:'20px'}}>
        <span>আপনার বাসা বাড়ির কাজের জন্য ইলেক্ট্রিশিয়ান দরকার হলে,আমাদের নিচের ফর্মটি পূরণ করে সাবমিট করুন</span>
        
      </Card.Text>
    <FormContainer>
      <h1 style={{color:'#0B8A55',textAlign:'center'}}>ইলেক্ট্রিশিয়ান সার্ভিস</h1>
