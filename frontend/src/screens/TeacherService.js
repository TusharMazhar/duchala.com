...
const TeacherService = () => {
  ...
  return (
    ...
    <Card.Text style={{margin:'auto',backgroundColor:'#0B8A55',color:'white',textAlign:'center',padding:'20px'}}>
      <span>আপনি যদি আপনার ছেলে মেয়েদের জন্য শিক্ষক নিয়োগ দিতে চান, তাহলে আমাদের নিচের ফর্মটি পূরণ করে সাবমিট করুন</span>
      
    </Card.Text>
  <FormContainer>
    <h1 style={{color:'#0B8A55',textAlign:'center'}}>শিক্ষক সার্ভিস</h1>
    <Form onSubmit={submitHandler}>
      ...
      <Form.Group controlId='description'>
        <Form.Label style={{display:'block'}}>শিক্ষকের বর্ণনা</Form.Label>
        <textarea
          style={{width:'300px',height:'100px',paddingLeft:'20px',paddingTop:'10px'}}
          type='description'
          placeholder='আপনি কি পড়াতে চান বিস্তারিত লিখুন'
          value={description}
