  ...
  return (
    <Card.Body>
      <Card.Text style={{margin:'auto',backgroundColor:'#0B8A55',color:'white',textAlign:'center',padding:'20px'}}>
        <span>আপনি যদি ই-কমার্স এপ্লিকেশন/কোন পেজ ডিজাইন/কোন পোস্টার/ লোগো বানাতে চান, তাহলে আমাদের নিচের ফর্মটি পূরণ করে সাবমিট করুন</span>
        
      </Card.Text>
    <FormContainer>
      <h1 style={{color:'#0B8A55',textAlign:'center'}}>ওয়েব এপ্লিকেশন/ডিজাইন সার্ভিস</h1>
